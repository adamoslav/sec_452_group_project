...
class plotting_agent:
    ...
    def plot_results(self):
        ...
        # calculating annualized sharpe ration
        ...
        print(f"MAS Maximum Drawdown: {system_drawdown * 100:.4f}%")
        print(f"{self._agent.capitalize()} Agent Maximum Drawdown: {agent_drawdown * 100:.4f}%")
        print(f"Baseline Approach Maximum Drawdown: {baseline_drawdown * 100:.4f}%")
